...
class Symbol(Base):
    ...
    issue_start_date = Column(DateTime(timezone=True))
    interest_payment_date = Column(DateTime(timezone=True))
    issue_maturity_date = Column(DateTime(timezone=True))
    ...
    expulsion_date = Column(DateTime(timezone=True))
    ...
    security_expiry_date = Column(DateTime(timezone=True))
    no_delivery_start_date = Column(DateTime(timezone=True))
    no_delivery_end_date = Column(DateTime(timezone=True))
    aon = Column(String)
    participant_in_market_index = Column(String)
    book_cls_start_date = Column(DateTime(timezone=True))
    book_cls_end_date = Column(DateTime(timezone=True))
    excercise_start_date = Column(DateTime(timezone=True))
    excercise_end_date = Column(DateTime(timezone=True))
    ...
    suspension_date = Column(DateTime(timezone=True))
